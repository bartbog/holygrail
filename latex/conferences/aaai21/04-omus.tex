...
\begin{proposition}\label{prop:K}
  Let $\m{H}=\mcses{\formula}$ be a set of correction subsets of \formula \tias{should be subset of correction subsets $H \subseteq mcss$?} \bart{the way it is phrased now also allows for non-minimal correction sets. Which is needed if grow is nonoptimal}. 
