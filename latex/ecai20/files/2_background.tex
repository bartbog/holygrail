...
Our proposed method is applicable to finite-domain constraint satisfaction problems. We use \textit{logic grid puzzles} as example domain, as it requires no expert knowledge to understand.
