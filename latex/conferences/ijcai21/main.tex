...
\newcommand{\emilio}[1]{{\color{orange}\comment{#1}}}
...
% what?
We %tackles two questions left in 
...
The method is applicable to other problems that require finding cost-optimal unsatiable subsets.
We specifically show that this approach can be used to effectively find sequences of \textit{optimal} explanations for constrained satisfaction problems like logic grid puzzles. The code and data is available at \url{https://github.com/ML-KULeuven/ocus-explain}. %\tias{die sourdough-bread leest wel heel vreemd... we hebben https://github.com/ML-KULeuven dat liever... zal ik daar forken?}
\end{abstract}
