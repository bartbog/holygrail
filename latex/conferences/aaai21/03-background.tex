...
In the next section, we discuss our basic OMUS algorithm. 
The algorithm of \citet{} can be obtained from \cref{alg:omus} by using cardinality as a cost function, hence we do not give it explicitly here. 
