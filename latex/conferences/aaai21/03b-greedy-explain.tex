...
More generally, the loop in \cref{alg:singleStepExplain} loops over all possibly derivable  literals $l$, searches for each of them an OUS and subsequently, the best of those is taken. 
