While our proposed method is applicable to constraint satisfaction problems in general, we use \textit{logic grid puzzles} as an example domain, as it requires no expert knowledge to understand.
...
\begin{align*}
 ...
 & \forall s\in sauce : \exists p\in pasta : paired\_with(s,p)\\
