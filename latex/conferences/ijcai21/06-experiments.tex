...
Our benchmarks were ran on the VUB Hydra cluster. Each solver call was assigned a single core on a 10-core INTEL E5-2680v2 (IvyBridge) processor \todo{Emilio,right?}, a timelimit of \todo{XX} minutes and a memory-limit of \todo{YY}GB.
 All code was implemented in Python on top of %CPpy~\footnote{} and
PySAT.\footnote{\url{https://pysathq.github.io}} The MIP solver used is Gurobi 9.0 and when a (Max)SAT solver is used it is RC2 as bundled with PySAT. 


All of our experiments were ran on a direct translation to CPPY of the the \todo{ten?} puzzles of \citet{ecai/BogaertsGCG20}. 
...
\begin{table*}
  ...
  \hline
    2 &        438 &    (7200, 0) &  (5693, 0) &            565 &          238 \\
    5 &       3382 &    (7200, 0) &  (7200, 0) &           7200 &         7200 \\
    3 &        477 &    (7200, 0) &  (6726, 0) &            874 &          607 \\
    7 &        372 &    (7200, 0) &  (7200, 0) &            645 &          414 \\
    8 &        474 &    (7200, 0) &  (7200, 0) &            644 &          448 \\
    1 &        569 &    (7200, 0) &  (6836, 0) &            779 &          299 \\
    p &        224 &    (7200, 0) &  (3586, 0) &            618 &          528 \\
    4 &        624 &    (7200, 0) &  (4910, 0) &            314 &           97 \\
   10 &        766 &    (7200, 0) &  (7200, 0) &           2308 &         1135 \\
    6 &        568 &    (7200, 0) &  (7200, 0) &            371 &          146 \\
  \hline
  \end{tabular}
  \end{table*}
