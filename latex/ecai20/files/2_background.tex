...
where $\ltrue$ stands for true, $\lunkn$ for unknown, and $\lfalse$ for false. In case nothing \textbf{Tias: nothing of what?} is mapped to $\lunkn$, we call this an \emph{interpretation}. \textbf{tias 'full' interpretation to discriminate with partial? I need that distinction in a later section...}
