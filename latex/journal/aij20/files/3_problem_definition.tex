\todo{The macro \allconstraints should be changed to jsut $T$, not $T_P$ since $T_P$ refers to a Puzzle P. This should be done carefully so that no ambiguity is created. Also in the section on logic grid puzzles $T_P$ shoudl be used. }
...
\begin{itemize}
	...
	\item $S_i \subseteq T_P$ (i.e., a subset of the constraints are used), and 
