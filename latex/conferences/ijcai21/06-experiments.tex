...
\item \emph{Sat} refers to ignoring \grow and simply adding the complement of the model when algorithm \ref{alg:comus} queries for satisfiability of the hitting set.
