...
\begin{definition}
    A subset $\m{C} \subseteq \formula$ is a \emph{Minimal Correction Subset} (MCS) if $\formula\setminus\m{C}$ is satisfiable, while for all 
...
. The core of their SMUS algorithm is as follows:
