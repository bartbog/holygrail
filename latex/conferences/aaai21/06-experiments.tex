...
Finally, for \textbf{RQ3} we compare the sequence found by our proposed method with the sequence reported on in~\cite{ecai/BogaertsGCG20} for the origin puzzle. We apply the same cost function as Bogaerts et al.~\cite{ecai/BogaertsGCG20} for the origin puzzle. Table \tias{Emilio: ...}
