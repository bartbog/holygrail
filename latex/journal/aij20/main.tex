...
%%%%%%%%%%%%%%%%%%%%%%%
%% `User comments`
\newcommand{\bart}[1]{\marginpar{\tiny\color{red}\textsc{BB:}#1}}
\newcommand{\tias}[1]{\marginpar{\tiny\color{red}\textsc{TG:}#1}}
\newcommand{\emilio}[1]{\marginpar{\tiny\color{red}\textsc{EG:}#1}}
\newcommand{\todo}[1]{\marginpar{\tiny\color{red}\textsc{TODO:}#1}}
\newcommand\ignore[1]{}
