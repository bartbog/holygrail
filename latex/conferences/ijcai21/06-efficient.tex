...
\emilio{Our OCUS algorithm in~\ref{alg:comus} is generic and can also be used to find OUSs, i.e by setting $p$ simply to \textit{true}. % In algorithm \ref{alg:comus}, this boils down to replacing line 2 with $\cohs(\setstohit,f,True)$
}
