...
We implemented these ideas in the \call{cppy} framework \cite{cppy}  and experimentally validate them on some puzzles of \citet{ecai/BogaertsGCG20} as well as on CNF problems from SOMEWHERE.
...
\todo{do we?} In \cref{sec:davies}, we discuss how the ideas of \citet{davies} can be transferred to the constrained OUS setting. 
