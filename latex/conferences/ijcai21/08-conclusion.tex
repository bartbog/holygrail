...
Incrementality still remains an unresolved question especially when considering applications where incrementality can also play across different queries.
...
\added{The experimental results for generating a single optimal explanation are encouraging for  (near) real-time settings such as interactive configuration applications~\cite{van2017kb}}
