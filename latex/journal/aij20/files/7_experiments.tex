...
\begin{figure}[h]
	...
	\caption{\emilio{Graph has been adapted with the puzzles in same ordering as the table.}
		Distribution of the ratio of the cost of a nested explanation sequence step and the cost of original explanation step for all puzzles. 
