...
When aiming to explain satisfaction problems in terms of the subset of constraints and literals needed to derive a new literal, the initial interpretation $I$ should consist of indicators literals for each (group of) constraint(s) as well as already known true literals. \bart{quite brief. I might expand but I first continue.}
...
Experiments have shown that such a MUS-based approach can easily take hours, even on simple puzzles, and hence that algorithmic improvements are needed to make it more practical. 
