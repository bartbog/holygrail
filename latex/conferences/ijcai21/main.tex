...
\newcommand{\emilio}[1]{{\comment{\color{orange}#1}}}
...
We show that this approach can be used to effectively find sequences of \textit{optimal} explanations for constrained satisfaction problems like logic grid puzzles. \emilio{The code and data is available at \url{https://github.com/sourdough-bread/ocus-xplain}.}
\end{abstract}
