...
\newcommand{\emilio}[1]{{\color{orange}\comment{NEW: #1}}}
...
\bart{Before submitting: remove all the delete... commands. They sometimes cause extra spacing if not used carefully}
\bart{the same for all the emilios: do not just make them not orange, remove the commands}
