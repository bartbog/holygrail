...
(typed) constant symbols, and (typed) relation symbols with associated type signature (i.e., each relation symbol is typed $T_1\times \dots \times T_n$ with $n$ types $T_i$).\footnote{We here omit function symbols since they are not used in this paper.} 
