...
\emilio{With these four observations in mind, we devised $f$ and $g$ as follows (where $nc(S)$ denotes the number of clues in constraint set $S$, $M$ and $N$ are explanation parameters): \label{sec:cost}
