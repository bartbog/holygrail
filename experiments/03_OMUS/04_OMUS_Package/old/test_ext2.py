...
def benchmark_code():
    ...
    folder = f'{user_folder}/results/{date.today().strftime("%Y_%m_%d")}_ext2/'
    ...
    #         # output folders
    #         orToolsOutput_random = orToolsFolder + basefileName+'_random' + '.json'
    ...
    for extension in extensions:
        for i, cnf in enumerate(cnf_instances):
            ...
            print("OrTools - extension", extension, "output=",omusGurobiCold_random)
            ...
            print("OrTools - extension", extension, "output=",omusGurobiCold_bestliteral)
            ...
            print("OrTools - extension", extension, "output=",omusGurobiCold_bestliteral2)
    ...
    for extension in extensions:
        for i, cnf in enumerate(cnf_instances):
            ...
            print("OrTools - extension", extension, "output=",omusGurobi_random)
            ...
            print("OrTools - extension", extension, "output=",omusGurobi_bestliteral)
            ...
            print("OrTools - extension", extension, "output=",omusGurobi_bestliteral2)
