...
\begin{figure}[h]
	...
	\caption{Distribution of the ratio of the cost of a nested explanation sequence step and the cost of original explanation step for all puzzles. \bart{is this correct? Goes all the way up to 100\% -- yes; it it looks close bu tis not 100\%, see updated text}} 
