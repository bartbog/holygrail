...
Satisfaction of a formula \formula by an interpretation is defined as usual\tias{bit blunt}. 
...
\begin{definition}
    ...
    Such a \m{C} is a \emph{minimal correction subset} (MCS)  of \formula if no strict subset of \m{C} is also a correction subset. 
...
It is well-known that each  MCS of \formula is the complement of an MSS of \formula and vice versa\tias{some well-known citation? or Ignatiev}. 
