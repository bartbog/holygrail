...
A further analysis of the overall execution times highlights that postponing the MIP call effectively redistributes 50\% of the load to the greedy and incremental hitting set heuristic .
