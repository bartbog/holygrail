...
% \renewcommand{\tias}[1]{{\comment{\color{blue}\textsc{TG:}}}}
% \renewcommand{\emilio}[1]{{\comment{\color{orange}\textsc{EG:}}}}
% \renewcommand{\bart}[1]{{\comment{\color{green}\textsc{BB:}}}}
% \renewcommand{\todo}[1]{{\comment{\color{red}\textsc{TODO:}} }}
