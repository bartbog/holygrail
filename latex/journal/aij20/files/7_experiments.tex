...
\begin{table}[t]
	...
	\end{tabular}
	\caption{Properties of the nested explanations. \tias{should be 100\% on last line for nested among? at least for m-i I guess?} \bart{These numbers supiciously add up to 100\%} \bart{ALso: the meaning of the different columns should somewhere be explained ``\% steps with nested among'' is unclear.}}
...
\begin{figure}[h]
	...
	\caption{Distribution of the ratio of the cost of a nested explanation sequence step and the cost of original explanation step for all puzzles. \bart{is this correct? Goes all the way up to 100\%}} 
