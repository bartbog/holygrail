...
%=======
Algorithm~\ref{alg:comus} is generic and can also be used to find OUSs with a trivially true $p$. % In algorithm \ref{alg:comus}, this boils down to replacing line 2 with $\cohs(\setstohit,f,True)$
