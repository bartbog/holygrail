...
Instead of directly adding the complement of $\m{S}$, similar to \cite{ignatiev2015smallest}, our proposed algorithm includes a call to \grow, which extends $\m{S}$ into a larger subset of $\formula$ that is still satisfiable (if possible).
