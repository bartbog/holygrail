...
Our work is motivated by Eugene Freuder's ``Holy Grail Challenge''\footnote{URL}\tias{TODO URL} which had as objective to provide automated processing of logic grid puzzles specifically, ranging from natural language processing, to solving, and explanining. 
