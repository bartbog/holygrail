...
\begin{definition}
We define the \textbf{maximal consequence} of a theory $\allconstraints$ and partial interpretation $I$ (denoted $max(I,T)$) as the most precise partial interpretation $J$ such that  $I \wedge \allconstraints \entails J$. 
\end{definition}
...
In line with the goal of ``simple enough for a person to understand'' and Occam's Raz
