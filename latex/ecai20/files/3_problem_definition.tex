...
The overarching goal is to generate a sequence of small reasoning steps, each with an interpretable explanation. We first introduce the concept of an explanation of a reasoning step, after which we define a cost function for a reasoning step so that we can define the cost of a sequence of reasoning steps. 
...
\tias{MUS naar lager, non-redundant is subset-minimal laten}
