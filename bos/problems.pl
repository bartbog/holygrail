...
:- use_module(problemsHolyGrail, [problem/2 as problemHolyGrail]).

problem(X, Y) :-
    problemPosterEvaluation(X, Y).
problem(X, Y) :-
    problemHolyGrail(X, Y).
...
problem(zebra, problem(5, 5, [
        "the ukranian drinks from tea",
        "the englishman lives in the red house",
        "the spaniard owns the dog",
        %"coffee is drunk in the green house",
        "the green house drinks from coffee",
        %"the green house is immediately to the right of the ivory house",
        "the green house ranked one higher than the ivory house",
        "the old gold smoker owns snails",
        %"the kools are smoked in the yellow house",
        "the kools smoker lives in the yellow house",
        %"milk is drunk in the middle house",
        "the man who drinks from milk lives in the house ranked 3",
        "the norwegian is ranked 1",
        "the man who smokes chesterfields lives in the house either one higher or one lower than the man with the fox",
        "kools are smoked in the house next to the house where the horse is kept",
        %"the lucky strike smoker drinks orange juice",
        "The smoker who smokes lucky strike drinks orange juice",
    ...
    tv([owns], [own]),
    tv([ranked], [rank]),
    tvPrep([drinks], [from], [drink], [drunk]),
    tvPrep([lives], [in], [live], [lived]),
