...
\end{compactdesc}
In the experiments, more specifically when generating explanation sequence of puzzles, the constraint(s) in the unsatisfiable represent using either \textit{bijectivity}, \textit{transitivity} or \textit{clues} or any combination thereof. \bart{too much detail... -> Requries explaingin what ``transtiivity'' etc mean in this setting) }
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\columnwidth]{figures/rq1_heatmap.pdf}
