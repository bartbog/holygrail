...
\emilio{In the context of interactive explanations, the Mixed-Initiative Intelligent Tutoring System (MITS) explores modeling the user being taught by an (M)ITS for solving Sudoku problems similar to an XAI \cite{caine2006mits}.}
