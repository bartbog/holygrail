...
\emilio{Incrementality still remains an unresolved question for other applications where incrementality can also play across different queries}
...
\emilio{The experimental results for generating a single explanation are encouraging, particularly in real-time settings such as interactive configuration applications~\cite{van2017kb}}
