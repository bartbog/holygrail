...
To compute an explanation, this procedure iterates over the literals that are still to explain, computes for each of them an associated MUS and subsequently selects \emilio{the lowest cost one from found MUSes}\deleted{the best of the found such MUSs}.  
