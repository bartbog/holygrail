...
Only for instances 1, 2 and 3, is the algorithm able to complete the search for \texttt{OUS}s on the 10 decision variables within the required time constraint.\tias{remove other ones, say that larger instances timed out in the text}
