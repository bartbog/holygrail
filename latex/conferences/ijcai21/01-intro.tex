...
\begin{compactitem}
 \item We develop algorithms that compute \textbf{\emilio{(cost-)}Optimal} Unsatisfiable Subsets (from now on called OUSs) based on the well-known hitting-set duality that is also used for computing cardinality-minimal MUSs \cite{ignatiev2015smallest}.
