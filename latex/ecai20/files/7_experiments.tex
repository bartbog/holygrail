...
\textbf{puzzle} & \textbf{avg. fact used} & \textbf{avg. fact used together with a clue} & \textbf{avg. fact used together with trans.} & \textbf{avg. fact used together with bij.}\\ 
\hline 
