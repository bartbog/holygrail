...
\answer{
	...
	The parameters $N$ (the cost of using a constraint) is taken to be relatively small, but more costly than a few facts $|E|$; $M$ is taken here to be larger than any reasonable explanation size  i.e. $|E| + N \cdot |S|$.
