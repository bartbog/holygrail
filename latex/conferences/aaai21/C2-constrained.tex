...
We can see that in general, for an OUS of $\formulac \cup I_{end} \cup \overline{\Iend}$ to be a valid explanation, it needs to satisfy a number of constraints. %Let $I$ be the set of already explained literals, as in Algorithm~\ref{alg:bestStepOUS}. 
