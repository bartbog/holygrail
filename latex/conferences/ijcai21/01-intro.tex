...
In that work, from a given classifier, and a concrete classified instance, a propositional theory explains which set of features values of the instance are responsible for the predicted class.
