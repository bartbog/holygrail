...
More generally, we keep track of the upper bound for every remaining literal to explain.
To potentially guide the search for the next best explanation, we sort the remaining literals-to-explain according to their best upper bound found so far.}
