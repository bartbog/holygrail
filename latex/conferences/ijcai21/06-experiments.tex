...
\item \emph{no-grow} refers to ignoring \grow and simply adding the complement of the model found by algorithm \ref{alg:comus}, line \ref{alg:ocus-sat-check} queries for satisfiability of the hitting set.
