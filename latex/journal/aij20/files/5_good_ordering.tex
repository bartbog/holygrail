...
\paragraph{Observation 2: Clues rarely propagate by themselves}
...
With these three observations in mind, we devised $f$ and $g$ as follows (where $nc(S)$ denotes the number of clues in constraint set $S$): \label{sec:cost}
