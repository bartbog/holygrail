...
Thereby, we aim to give the constraint solver explainable agency, which can help in building trust \emilio{of the user} in the solver by being able to understand and even learn from the explanations.
