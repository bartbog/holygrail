...
\begin{algorithm}[H]
  ...
  \While{true}{
    ...
    % \emilio{
      \emilio{Add mode to algorithm for postponing optimisation. Mode switch corresponds to switching between heuristic conditional Hitting set computation and the optimizer.}\;
