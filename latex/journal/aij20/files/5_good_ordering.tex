...
\emilio{The parameters $M$ is taken here to be larger than any reasonable explanation size and $N$ to be relatively small in comparison. In our experiments, we use the combination $M=100$ and $N=5$ which provided good explanation sequences for the tested puzzles.}
