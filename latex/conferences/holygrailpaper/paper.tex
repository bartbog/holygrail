...
%  \pdfinfo{
% /Title (User-Oriented Solving and Explaining of Natural Language Logic Grid Puzzles) % TODO
% /Author (Jens Claes, Bart Bogaerts, Rocsildes Canoy, Tias Guns) % TODO
% } %Leave this	
% /Title ()
