...
All variants time out on the larger instances (par8-5, par16-1, par16-2, par16-3, par16-4-c, par16-4, hanoi4) finding the \texttt{OUS}s for up to 6 out of the 10 decision variables. \bart{MEER DETAIL}
