...
\begin{table}
	...
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{l|c|ccc|cccc} 
		    & \multicolumn{4}{c|}{avg. facts} & \multicolumn{4}{c}{\% of clue expl. with facts} \\
...
\begin{table}
	...
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{|l||c|c|c|c|} 
			\hline 
			\textbf{puzzle} & \textbf{avg. facts} & \textbf{avg. facts w/ clue} & \textbf{avg. facts w/ bij.} & \textbf{avg. facts w/ tr.}\\ 
			\hline 
...
\begin{table}
	...
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{c|cccc|cccccc} 
			...
			\hline 
			p5.output.json & 4 & 5 & 150 & 113 & 30.97 & 30.97 & 18.58 & 0.0 & 0\\ 
			\hline 
			p16.output.json & 4 & 5 & 150 & 122 & 21.31 & 21.31 & 18.85 & 0.0 & 0\\ 
			\hline 
			p93.output.json & 4 & 5 & 150 & 119 & 33.61 & 33.61 & 18.49 & 0.0 & 0\\ 
			\hline 
			p12.output.json & 4 & 5 & 150 & 115 & 28.7 & 28.7 & 16.52 & 0.0 & 0\\ 
			\hline 
			p18.output.json & 4 & 5 & 150 & 116 & 27.59 & 27.59 & 17.24 & 0.0 & 0\\ 
			\hline 
			p20.output.json & 4 & 5 & 150 & 116 & 26.72 & 26.72 & 14.66 & 0.0 & 0\\ 
			\hline 
			nielspasta.output.json & 4 & 5 & 150 & 82 & 34.15 & 34.15 & 21.95 & 2.44 & 0\\ 
			\hline 
			p25.output.json & 4 & 5 & 150 & 111 & 36.94 & 36.94 & 17.12 & 0.0 & 0\\ 
			\hline 
			p19.output.json & 4 & 5 & 150 & 123 & 24.39 & 24.39 & 16.26 & 0.0 & 0\\ 
		\end{tabular} 
