...
Hence, in our implementation, we ensure that they are always performed first. Stated differently, $g$ and $f$ are desigend in such a way that $g(S_1)\geq f(I,S_2)$ whenever $S_2$ consists of only one implicit constraint and $S$ does not. 
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{zebra_screen_2}
