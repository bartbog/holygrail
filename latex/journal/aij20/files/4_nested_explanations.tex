...
\revision{An example of a more difficult step is depicted at the top in Figure \ref{fig:pasta_diff}. It uses a disjunctive clue (`The person who ordered Rotini is either the person who paid \$8 more than Damon or the person who paid \$8 less than Damon'), in combination with three previously derived facts to derive that Farfalle does not cost \$8.
...
\revision{This novel approach allows us to provide a mechanism for \emph{zooming in} into the more difficult explanation steps of the explanation sequence.}
