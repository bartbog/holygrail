...
\emilio{In the context of interactive explanations, \cite{caine2006mits} introduce an \emph{mixed-initiative} Intelligent Tutoring System (MITS), similar to XAI, as a teaching system for solving Sudoku problems where both the user and the system take the initiative to interact.
