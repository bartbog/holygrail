...
\deleted{Satisfaction of a formula \formula by an interpretation is defined as usual~\cite{faia/2009-185}}\emilio{Satisfaction of an interpretation $\m{I}$ for a formula \formula is defined as a truth assignment, i.e. \textit{True} or \textit{False} (resp. 1 or 0), to all variables in $\m{I}$ and checking if \formula evaluates to \textit{True} or \textit{False} (that is satisfiable or not)~\cite{faia/2009-185}.}
