...
We assume given a theory $\allconstraints$ and initial partial interpretation $I_0$. We denote by $I_n$ the partial interpretation that is consistent with $\allconstraints$ and $I_0$, e.g. $I_0 \wedge \allconstraints \entails I_n$. \tias{or that results from propagating $T_p$? That are a logical consequence, but any subset of $I_n$ will be a logical consequence? that is maximally consistent?}
