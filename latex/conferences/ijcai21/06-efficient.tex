...
\emilio{While our OCUS algorithm in~\ref{alg:comus} is generic and it can also be used to find OUSs, i.e by removing predicate $p$. In algorithm \ref{alg:comus}, this boils down to replacing line 2 with $\cohs(\setstohit,f,True)$}. However, its constrainedness property is key to decreasing the complexity of explanation sequence generation.
