...
I would call $C\land B \rightarrow A$ plus a visualisatoin thereof an explanation, but the pure mathematic object $(C,B)$ is not really an explanation yet. (not sure if we have to make this distinction in the text)
}
