...
Instead of directly adding the complement of $\formula'$, similar to \cite{}\tias{which one? I think they all do a grow/shrink...}, our proposed algorithm includes a call to \grow, which extends $\formula'$ into a larger subset of $\formula$ that is still satisfiable (if possible).
