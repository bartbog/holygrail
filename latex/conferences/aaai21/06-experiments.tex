...
As a matter of fact, the sequence is generated in a bit more than 21 minutes compared to a few (2-3) hours in~\cite{ecai/BogaertsGCG20}, which means that \omus Constr is 8-10x faster!
The average cost is slightly lower and as well as $max(cost)$, the cost of the most difficult explanation in the puzzle. 
